...
export const createProfesionales = z.object({
  ...
  registroProfesional: z
    .string()
    .regex(
      /^[0-9A-Z]{5,15}$/,
      "El registro profesional debe ser alfanumérico (mayúsculas y números) y tener entre 5 y 15 caracteres."
    ),
  especialidad: z
    .string()
    .min(5, "Debe especificar la especialidad.")

...
export const createCitas = z.object({
  fechaHora: z.coerce.date({
    errorMap: (issue, ctx) => {
      if (issue.code === z.ZodIssueCode.invalid_date) {
        return {
          message:
            "Formato de fecha y hora inválido. Se espera formato ISO 8601 (ej. 'YYYY-MM-DDTHH:MM:SSZ').",
        }
      }
  ...
  motivo: z
    .string()
    .min(5, "El motivo de la cita es requerido.")
    .max(500, "El motivo no debe exceder los 500 caracteres."),
